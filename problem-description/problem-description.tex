...
This leads to problems for artists as digital streaming has become their main source of income in recent years. According to \cite{ifpi2020global}, 2019 became the first year in which digital streaming is the single biggest source of revenue for the music industry globally. This trend is has shifted power from decentralized music stores to centralized streaming services.

\begin{table}[]
\begin{tabular}{|l|l|l|l|l|l|}
\hline
\textbf{}                      & \textbf{Music release type} & \textbf{Label cut} & \textbf{Platform cut} & \textbf{Artist/band cut} & \textbf{\begin{tabular}[c]{@{}l@{}}Streams per month \\ to earn min. wage \\ (solo musician)\end{tabular}} \\ \hline
