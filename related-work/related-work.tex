...
In essence, BitTorrent makes use of seeding while downloading: this means that when multiple clients download a file, they simultaneously share pieces of this file with the other downloaders. This results, with well connected and performing peers, in fast downloads. A key challenge is finding and connecting to healthy \textit{swarms}: groups of uploaders and downloaders that are interested in some piece of content.
